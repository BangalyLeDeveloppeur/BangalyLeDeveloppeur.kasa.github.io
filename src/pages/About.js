...
import Photapropos from "../components/photoapropos/Photapropos";
  ...
  <div className="annonce">
    <div className="chevron-cadr">
      <p>
        ...
        comportement de discrimination ou de perturbation du voisinage
  ...
  <div className="annonceSecurite">
    <div className="chevron-cadr">
      <p>
        ...
        établies par nos services. En laissant une note aussi bien à l'hôte
